...
export const ScriptStore: Scripts[] = [
  ...
  { name: 'dataTables.buttons', src: 'assets/js/bundles/export-users/dataTables.buttons.min.js' },
  { name: 'editable-table', src: 'assets/js/bundles/editable-table/mindmup-editabletable.js' },
  { name: 'buttons.flash', src: 'assets/js/bundles/export-users/buttons.flash.min.js' },
  { name: 'jszip', src: 'assets/js/bundles/export-users/jszip.min.js' },
  { name: 'buttons.html5', src: 'assets/js/bundles/export-users/buttons.html5.min.js' },
  { name: 'buttons.print', src: 'assets/js/bundles/export-users/buttons.print.min.js' },
